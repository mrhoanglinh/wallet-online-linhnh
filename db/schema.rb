...
ActiveRecord::Schema.define(version: 20170420161205) do
  ...
  create_table "cost_categories", force: :cascade do |t|
    ...
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["category_id"], name: "index_cost_categories_on_category_id"
    t.index ["cost_id"], name: "index_cost_categories_on_cost_id"
  end
